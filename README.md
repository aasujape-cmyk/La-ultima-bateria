...
3. Mecánicas de Juego (Gameplay)
    ...
    3.1. Movimiento: El jugador controla al robot en 8 direcciones usando las teclas WASD.
...
6. Apartado Técnico y Recursos
   ...
   7. Dificultad Dinámica y Features Extra
    ...
    7.4. Luces de Emergencia:
        ...
        -Cuando la energía baje del 25%, la pantalla (o el robot) empieza a parpadear en rojo y suena una alarma suave. 
